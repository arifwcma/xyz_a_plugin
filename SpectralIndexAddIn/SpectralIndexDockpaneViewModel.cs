...
namespace SpectralIndexAddIn
{
    ...
    public class SpectralIndexDockpaneViewModel : INotifyPropertyChanged
    {
        ...
        public SpectralIndexDockpaneViewModel()
        {
            ...
            UpdateLayerCommand = new RelayCommand(OnUpdateLayer, CanUpdateLayer);
        ...
        private void OnLayerSelectionChanged(object sender, MapViewEventArgs e)
        {
        ...
        {
            var params = LayerManager.GetLayerParameters(layer);
            if (params != null)
            {
                _currentLayerParams = params;
                SelectedIndex = params.Index;
                StartDate = params.StartDate;
                EndDate = params.EndDate;
                CloudTolerance = params.CloudTolerance;
            }
        }
